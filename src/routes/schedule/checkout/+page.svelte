...
<section class="content">
  ...
  <main class="content__main">
    ...
    <p class="content__main__subtitle">Para garantir um melhor atendimento recomendamos aos clientes que cheguem no local do serviço com 15 minutos de antecedência.</p>
